...
-->
<p:config xmlns:p="http://www.orbeon.com/oxf/pipeline" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:oxf="http://www.orbeon.com/oxf/processors" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    ...
    <p:processor name="oxf:xslt">
        ...
        <p:input name="config">
            <config xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xsl:version="2.0">
                ...
                <url>
                    ...
                    <xsl:value-of select="if ($instance/form) then $instance/form/file[1]                         else if (tokenize($url-parameter, ':')[1] = ('http', 'https')) then $url-parameter                         else ()"/>
                </url>
